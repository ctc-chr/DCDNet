...
from modules.scm_gate import STLightGate
from modules.PSAC_TtS_V2 import PSC
# from modules.PSAC_V2 import PSC
...
if __name__ == '__main__':
    input_tensor = torch.autograd.Variable(torch.rand(4, 3, 64, 112, 112))
