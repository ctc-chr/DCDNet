...
class TtS(nn.Module):
    def __init__(self, C):
        ...
        self.spatial_aggregation1 = nn.Conv3d(C, C, kernel_size=(5, 3, 3),
                                              padding=(2, 1, 1), groups=C)
        self.spatial_aggregation2 = nn.Conv3d(C, C, kernel_size=(5, 3, 3),
                                              padding=(4, 1, 1), dilation=(2, 1, 1), groups=C)
        self.spatial_aggregation3 = nn.Conv3d(C, C, kernel_size=(5, 3, 3),
                                              padding=(6, 1, 1), dilation=(3, 1, 1), groups=C)
