...
class SlowFast(nn.Module):
    def __init__(self, block=Bottleneck, layers=[3, 4, 6, 3], class_num=10, dropout=0.5):
        ...
        fast_ratio = 2
        self.lateral_fast_p1 = nn.Conv3d(8, 8 * fast_ratio, kernel_size=(5, 1, 1), stride=(8, 1, 1), bias=False, padding=(2, 0, 0))
        ...
        self.lateral_middle_res3 = nn.Conv3d(64, 64 * middle_ratio, kernel_size=(5, 1, 1), stride=(2, 1, 1), bias=False,
                                             padding=(2, 0, 0))
        self.lateral_middle_res4 = nn.Conv3d(128, 128 * middle_ratio, kernel_size=(5, 1, 1), stride=(2, 1, 1), bias=False,
                                             padding=(2, 0, 0))
