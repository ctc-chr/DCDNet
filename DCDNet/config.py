...
# params['num_classes'] = 173
# params['num_classes'] = 174
# params['num_classes'] = 100
# params['num_classes'] = 50
# params['num_classes'] = 226
# params['num_classes'] = 262

# params['dataset'] = r'/media/tian903/data/dataset/hmdb51/'
# params['dataset'] = r'/media/tian903/data/dataset/UCF101/'
params['dataset'] = r'/media/tian903/data/dataset/UCF101_magic/'
# params['dataset'] = r'/media/tian903/data/dataset/WLASL/WLASL-100/'
# params['dataset'] = r'/media/tian903/data/dataset/AUTSL/color_video/AUTSL-100/'
# params['dataset'] = r'/media/tian903/data/dataset/INCLUDE/include_data/INCLUDE-50/'
# params['dataset'] = r'/media/tian903/data/dataset/AUTSL/video/'
# params['dataset'] = r'/media/tian903/data/dataset/AUTSL/color_video/'
# params['dataset'] = r'/media/tian903/data/dataset/INCLUDE/include_data/'
# params['dataset'] = r'/media/tian903/data/dataset/ssv2/data/'
# params['dataset'] = r'/media/tian903/data/dataset/ssv1/data/'
